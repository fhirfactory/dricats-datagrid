package net.fhirfactory.dricats.datagrid.cachestore.fhirserver.client.search;
...
@ApplicationScoped
public class ProcedureSearches {
    private static final Logger LOG = LoggerFactory.getLogger(ProcedureSearches.class);

    public Bundle getProceduresWithSubjectAndDate(BaseFHIRClientService accessor, Map<Property, Serializable> parameterSet) {
    ...
    public Bundle getProceduresWithSubjectAndDate(BaseFHIRClientService accessor, String subjectIdentifierSystem, String subjectIdentifierTypeCode, String subjectIdentifierValue, Date startDate, Date endDate){
    ...
    public Bundle getProceduresWithSubjectAndDate(BaseFHIRClientService accessor, Identifier identifier, DateRangeParam dateRangeParam){
        String identifierTypeCode = null;
