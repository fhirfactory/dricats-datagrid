...
public class PatientSearches {
    private static final Logger LOG = LoggerFactory.getLogger(PatientSearches.class);

    @Inject
    SearchSupportHelper searchHelper;

    public Bundle doQRYA19(BaseFHIRClientService accessor, String subjectIdentifierSystem, String subjectIdentifierTypeCode, String subjectIdentifierValue, String queryString){
    ...
    public Bundle doQRYA19(BaseFHIRClientService accessor, TokenParam identifierParam, StringParam stringParam){
